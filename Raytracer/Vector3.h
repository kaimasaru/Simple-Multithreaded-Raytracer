...
public:
	...
	float magnitude() const { return fabs(sqrt(pow(x, 2) + pow(y, 2) + pow(z, 2))); }
	...
	Vector3 normalized() const { return magnitude() != 0 ? *this / magnitude() : *this; }
	...
	static Vector3 randomUnitVecHemisphere(const Vector3& normal) {
